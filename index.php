  ...
  <script type="application/ld+json">
    {
      ...
      "@type": "LocalBusiness",
      "name": "Rank You Higher",
      "image": "",
      "@id": "",
      "url": "https://rankuhigher.in/",
      "telephone": "9585380011",
      "address": {
        "@type": "PostalAddress",
  ...
  <script type="application/ld+json">
    {
      ...
      "alternateName": "RYH",
      "url": "https://rankuhigher.in/",
      "logo": "https://rankuhigher.in/assets/ryh-logo.png",
      "sameAs": "https://www.facebook.com/rankuhigher2020/"
    }
  </script>
  <!--<—---Website Schema:----->
...
<body>
        ...
        <div class="col-12 col-md-3">
          <div class="d-flex flex-column">
            ...
            <div class="fs-6 fw-500 my-4">
              ...
              that's Rank You Higher.
            </div>
            <div class="pt-1 my-1">
              <a class="btn btn-danger f-14 rounded-pill" href="contact-us.php">
                Contact us
              </a>
            </div>
          </div>
  ...
  <section>
    <div class="container-fluid parent-circle max-size">
      <div class="row g-0">
        <div class="col-12 col-lg-6 my-auto p-0 p-lg-4" data-aos="zoom-out-right">
          <div class="text-white d-flex flex-column p-2 p-lg-5">
            ...
            <div class="pt-3">
              <a href="./contact-us.php"><button class="btn btn-light rounded-pill f-16 fw-500 px-4 p-1 ">Let's
                  Talk</button></a>
            </div>
          </div>
        </div>
        <div class="col-12 col-lg-6 d-md-flex justify-content-center" data-aos="zoom-out-left" data-aos-delay="300">
          <div class="blk-border wid-fit c-design">
            <div class="blk-border p-5 m-5">
              <div class="circle">
                ...
                <div>
                  <!-- parent button -->
                  <p class="text-white position-absolute f-12 ppc-text"><i class="fa fa-info-circle"></i> Pay-Per-Click
                  </p>
                ...
                <div>
                  <!-- parent button -->
                  <p class="text-white position-absolute f-12 sem-text"><i class="fa fa-info-circle"></i> Search Engine
                    Marketing</p>
                ...
                <div>
                  <!-- parent button -->
                  <p class="text-white position-absolute f-12 gud-text"><i class="fa fa-info-circle"></i> Graphic &
                    UI|UX Design</p>
                ...
                <div>
                  <!-- parent button -->
                  <p class="text-white position-absolute f-12 wd-text"><i class="fa fa-info-circle"></i> Website
                    Development</p>
                ...
                <div>
                  <!-- parent button -->
                  <p class="text-white position-absolute f-12 ad-text"><i class="fa fa-info-circle"></i>App Development
                  </p>
                ...
                <div>
                  <!-- parent button -->
                  <p class="text-white position-absolute f-12 seo-text"><i class="fa fa-info-circle"></i> Search Engine
                    Optimization</p>
          ...
          <div class="c-design-md mt-3 mb-3">
            <div class="row g-0">
              <div class="col-4">
              ...
              <div class="col-12">
                <p class="text-white mt-3 mx-4">
                  <i class="fa fa-info-circle"></i> App Development
                </p>
              </div>
              <div class="col-12">
                <p class="text-white mx-4">
                  <i class="fa fa-info-circle"></i> Search Engine Optimization
                </p>
              </div>
              <div class="col-12">
                <p class="text-white mx-4">
                  <i class="fa fa-info-circle"></i> Branding
                </p>
              </div>
              <div class="col-12">
                <p class="text-white mx-4">
                  <i class="fa fa-info-circle"></i> Website Development
                </p>
              </div>
              <div class="col-12">
                <p class="text-white mx-4">
                  <i class="fa fa-info-circle"></i> Pay-Per-Click
                </p>
              </div>
            </div>
  ...
  <section class="our-services mb-5">
    <div class="container-fluid position-sticky-title">
      <h2 class="display-3 d-flex justify-content-center fw-bold sticky-column-title bg-white mt-5">OUR SERVICES
      </h2>
      <p class="fs-6 text-center mb-5">
        Transform your digital strategies and establish <br>a commanding online presence.
      </p>
      ...
      <div class="bg-grey my-5 py-4">
        <div class="container">
          <h2 class="fs-1 fw-500 text-secondary text-center">
            What is your goal?
          </h2>
          ...
          <div class="owl-carousel owl-carousel-3 owl-theme">
            <div class="item">
              <div class="op-g-card bg-white pt-4 pb-3 px-4">
                <h3 class="fs-5 fw-bold">
                Branding 
                </h3>
                <p class="text-justify">
                Transform your business identity with innovative branding solutions at Rank You Higher. We design compelling brand strategies that resonate with your audiences, increase recognition, and uphold their long-term trust in your business in challenging markets.
                </p>
              </div>              
            </div>
            <div class="item">
              <div class="op-g-card bg-white pt-4 pb-3 px-4">
                ...
                <p class="text-justify">
                Elevate your online presence with intuitive UI/UX designs from Rank You Higher. We design user-centric interfaces that ensure seamless navigation, captivating visuals, and optimized performance throughout the different platforms to deliver exceptional customer experiences.
                </p>
              </div>              
            </div>
            <div class="item">
              <div class="op-g-card bg-white pt-4 pb-3 px-4">
                ...
                <p class="text-justify">
                Creative design brings ideas to life. From explosive graphics to impactful layouts, Rank You Higher blends innovation and strategy to create highly informative designs for materials about your brand that strike the audience's interest and drive engagement for your brand.
                </p>
              </div>              
            </div>
            <div class="item">
              <div class="op-g-card bg-white pt-4 pb-3 px-4">
                ...
                <p class="text-justify">
                Get superior online exposure with Rank You Higher's professional SEO services. We help your website rank higher, attracting organic traffic and turning visitors into loyal customers, ensuring long-term success in the online landscape.
                </p>
              </div>              
            </div>
            <div class="item">
              <div class="op-g-card bg-white pt-4 pb-3 px-4">
                ...
                <p class="text-justify">
                Get better returns on digital advertising by tapping Rank You Higher's SEM solutions. Our SEM solutions will allow you to develop campaigns prepared to attract the right traffic that builds leads and increases conversion rates while keeping your brand in the competing search engine marketing arena.
                </p>
              </div>              
            </div>
            <div class="item">
              <div class="op-g-card bg-white pt-4 pb-3 px-4">
                ...
                <p class="text-justify">
                Reach your target audience and expand your social footprint with SMM services from Rank You Higher. We create compelling content, run campaigns, and facilitate engagement to build your brand's devoted social media following.
                </p>
              </div>              
            </div>
            <div class="item">
              <div class="op-g-card bg-white pt-4 pb-3 px-4">
                ...
                <p class="text-justify">
                Impress your target audience with beautiful, adaptable, and interactive web design with the help of services with Rank You Higher. Aesthetics, functionality, and high performance ensure an engaging brand presence in the digital world.
            ...
            <div class="item">
              <div class="op-g-card bg-white pt-4 pb-3 px-4">
                ...
                <p class="text-justify">
                Rank You Higher is the best platform for transforming ideas into engaging mobile experiences. We offer feature-rich, user-friendly mobile apps for your business needs and cutting-edge solutions on iOS and Android platforms.
                </p>
              </div>              
            </div>
            <div class="item">
              <div class="op-g-card bg-white pt-4 pb-3 px-4">
                ...
                <p class="text-justify">
                Get results instantly with Rank You Higher's PPC campaigns. With data-driven strategies, we ensure high-quality leads, increased visibility, and maximum ROI by effectively managing your paid advertisements on search engines and social media platforms.
                </p>
              </div>              
            </div>
            <div class="item">
              <div class="op-g-card bg-white pt-4 pb-3 px-4">
                ...
                <p class="text-justify">
                Develop your web presence with Rank You Higher's web development services. Whether a scalable, secure, or dynamic website, we design for a specific need to provide your audience with the best performance and experience.
                </p>
              </div>              
            </div>
            <div class="item">
              <div class="op-g-card bg-white pt-4 pb-3 px-4">
                ...
                <p class="text-justify">
                  Take your business to the next level with web app development provided by Rank You Higher. Build innovative, secure, high-performing web applications that streamline operations, increase efficiency, and create excellent user experiences.
                </p>
              </div>              
            </div>
      ...
      <div class="container">
        <div class="row design">
          <!-- First Column -->
          <div class="col-12 col-lg-6">
            <div class="sticky-column d-flex flex-column">
              <h3 class="display-2 fs-2 d-flex justify-content-center fw-bold pb-4 text-secondary"><u>DESIGN</u>
              </h3>
              <a id="uiux" class="btn btn-light-grey p-3 p-md-2 m-2 mx-lg-5" href="#uiux-card">UI / UX Designing</a>
              <a id="smm" class="btn btn-light-grey p-3 p-md-2 m-2 mx-lg-5" href="#smm-card">Social Media Designing</a>
              <a id="ve" class="btn btn-light-grey p-3 p-md-2 m-2 mx-lg-5" href="#ve-card">Video Editing</a>
              <a id="ld" class="btn btn-light-grey p-3 p-md-2 m-2 mx-lg-5" href="#ld-card">Logo Design</a>
              <a id="pad" class="btn btn-light-grey p-3 p-md-2 m-2 mx-lg-5" href="#pad-card">Paper Ad Design</a>
            </div>
          </div>

          <!-- Second Column -->
          <div class="col-12 col-lg-6">
            <div target="uiux" class="card myCard" id="uiux-card">
              <div class="card-body">

              </div>
            </div>
            <div target="smm" class="card myCard" id="smm-card">
              <div class="card-body">

              </div>
            </div>
            <div target="ve" class="card myCard" id="ve-card">
              <div class="card-body">

              </div>
            </div>
            <div target="ld" class="card myCard" id="ld-card">
              <div class="card-body">

              </div>
            </div>
            <div target="pad" class="card myCard" id="pad-card">
              <div class="card-body">
      ...
      <div class="container">
        <div class="row business">
          ...
          <div class="col-12 col-lg-6">
            <div class="sticky-column d-flex flex-column">
              <h3 class="display-2 fs-2 d-flex justify-content-center fw-bold pb-4 text-secondary"><u>BUSINESS</u>
              </h3>
              <a id="branding" class="btn btn-light-grey p-3 p-md-2 m-2 mx-lg-5" href="#branding-card">Branding</a>
              <a id="seo" class="btn btn-light-grey p-3 p-md-2 m-2 mx-lg-5" href="#seo-card">Search Engine
                Optimization</a>
              <a id="sm" class="btn btn-light-grey p-3 p-md-2 m-2 mx-lg-5" href="#sm-card">Social Marketing</a>
              <a id="wd" class="btn btn-light-grey p-3 p-md-2 m-2 mx-lg-5" href="#wd-card">Web Designing</a>
              <a id="ppc" class="btn btn-light-grey p-3 p-md-2 m-2 mx-lg-5" href="#ppc-card">Pay-Per-Click</a>
            </div>
          </div>

          <!-- Second Column -->
          <div class="col-12 col-lg-6">
            <div target="branding" class="card myCard" id="branding-card">
              <div class="card-body">

              </div>
            </div>
            <div target="seo" class="card myCard" id="seo-card">
              <div class="card-body">

              </div>
            </div>
            <div target="sm" class="card myCard" id="sm-card">
              <div class="card-body">

              </div>
            </div>
            <div target="wd" class="card myCard" id="wd-card">
              <div class="card-body">

              </div>
            </div>
            <div target="ppc" class="card myCard" id="ppc-card">
              <div class="card-body">
      ...
      <div class="container">
        <div class="row technology">
          ...
          <div class="col-12 col-lg-6">
            <div class="sticky-column d-flex flex-column">
              <h3 class="display-2 fs-2 d-flex justify-content-center fw-bold pb-4 text-secondary"><u>TECHNOLOGY</u>
              </h3>
              <a id="wd2" class="btn btn-light-grey p-3 p-md-2 m-2 mx-lg-5" href="#wd2-card">Web Design</a>
              <a id="ma" class="btn btn-light-grey p-3 p-md-2 m-2 mx-lg-5" href="#ma-card">Mobile Apps</a>
              <a id="wa" class="btn btn-light-grey p-3 p-md-2 m-2 mx-lg-5" href="#wa-card">Web Apps</a>
              <a id="fe" class="btn btn-light-grey p-3 p-md-2 m-2 mx-lg-5" href="#fe-card">Front-end</a>
              <a id="be" class="btn btn-light-grey p-3 p-md-2 m-2 mx-lg-5" href="#be-card">Back-end</a>
            </div>
          </div>

          <!-- Second Column -->
          <div class="col-12 col-lg-6">
            <div target="wd2" class="card myCard" id="wd2-card">
              <div class="card-body">

              </div>
            </div>
            <div target="ma" class="card myCard" id="ma-card">
              <div class="card-body">

              </div>
            </div>
            <div target="wa" class="card myCard" id="wa-card">
              <div class="card-body">

              </div>
            </div>
            <div target="fe" class="card myCard" id="fe-card">
              <div class="card-body">

              </div>
            </div>
            <div target="be" class="card myCard" id="be-card">
              <div class="card-body">
  ...
  <!-- <section class="our-services-mb">
    ...
    <div class="bg-grey my-5 py-4">
      <div class="container">
        <h2 class="fs-6 fw-500 text-secondary text-center">
          Our websites are already delivering
        </h2>
        <h2 class="fs-3 fw-500 text-center">
          Outstanding performance <span class="text-danger">on Google</span>
        </h2>
        <div class="row my-3 gy-3">
          <div class="col-12 col-lg-4">
            <div class="h-100 op-g-card bg-white pt-4 pb-3 px-4">
              <h3 class="fs-5 fw-bold">
                Efficient Process
              </h3>
              <p class="text-justify">
          ...
          <div class="col-12 col-lg-4">
            <div class="h-100 op-g-card bg-white pt-4 pb-3 px-4">
              <h3 class="fs-5 fw-bold">
                Skilled Designers & Expert Developers
              </h3>
              <p class="text-justify">
                Our team consists of experienced professionals who excel in crafting pixel perfect, SEO friendly
                websites that are visually appealing and highly functional.
              </p>
            </div>
          </div>
          <div class="col-12 col-lg-4">
            <div class="h-100 op-g-card bg-white pt-4 pb-3 px-4">
              ...
              <p class="text-justify">
                With years of experience in web design, Rank You Higher has developed some of the most effective and
                complex strategies to date, ensuring your website stands out in this busy market.
              </p>
    ...
    <div class="container my-3">
      ...
      <div class="row gy-3">
        ...
        <div class="col-12 col-lg-5">
          ...
          <p class="bg-grey rounded-3 fs-16 p-3 text-justify mb-2">
            We design visibility-increasing engagement-driving strategies while maximizing ROI.
          </p>
          <p class="bg-grey rounded-3 fs-16 p-3 text-justify mb-2">
            Our creativity, innovation, and data-driven approaches will make your business stand out in increasingly
            competitive online spaces.
          </p>
  ...
  <section>
    <div class="container-fluid bg-lightgrey-2 p-5">
      <div class="row p-0 p-md-5">
        <div class="col-12 col-lg-6 my-auto">
          <h2 class="fs-3 fw-bolder lh" data-aos="zoom-out-right" data-aos-delay="300">
            Scale up your customer connections
          </h2>
  ...
  <section class="bg-cc my-3">
    <div class="container py-5">
      <div class="row mt-3 gy-3 gx-5">
        <div class="col-12 col-lg-9">
          <h2 class="fs-1 fw-bold text-danger">
            Transform Your Digital Presence<br> With Vision, Expertise, And Local Reach
          </h2>
          <p class="text-justify fs-5">
            Rank You Higher lets you transform your business's digital presence with innovative strategies, expert
            solutions, and a deep understanding of local markets. From branding to web development, we offer
            site-specific services that improve visibility, engagement, and growth, ensuring your success in today's
  ...
  <section>
    <div class="container-fluid mt-5 mb-5" data-aos="fade-down">
      <div class="container">
        <div class="home-demo">
          <div class="owl-carousel owl-carousel-1 owl-theme">
            <div class="item mt-5 py-5">
              <h2 class="fs-2 fw-bolder item-1 mt-3">
                Numbers Speak <br>Of Client's Trust
              </h2>
            </div>
            <div class="item">
              <div class=" item-2">
          ...
          <div class="owl-carousel owl-carousel-3 owl-theme">
            <div class="item">
              <div class="card p-1 pb-3 team">
                ...
                <div class="d-flex justify-content-center f-16 fw-normal">
                  Designation
                </div>
              </div>
            </div>
  ...
  <section>
    <div class="container my-5">
      ...
      <h2 class="fs-1 fw-bold text-center text-danger">
        Our Distinctive Features as a Leading <br>Digital Marketing Company
      </h2>


      <div class="row gy-3 gx-1 mt-4">
        <div class="col-12 col-lg-6">
          <div class="dp-bg rounded-4 p-3 mx-2 h-100">
            ...
            <div>
              <p class="text-justify mt-3">
                We do not settle for cut-and-dried solutions. Our team collaborates closely with clients to understand
                specific requirements, goals, and target groups before adapting customized plans for optimal results.
              </p>
            </div>
          </div>
        ...
        <div class="col-12 col-lg-6">
          <div class="dp-bg rounded-4 p-3 mx-2 h-100">
            ...
            <div>
              <p class="text-justify mt-3">
                Our team consists of professionals with many years of experience in different digital marketing skills.
                Our experts are talented and knowledgeable in managing complex campaigns that not only meet but exceed
                expectations.
              </p>
            </div>
          </div>
        ...
        <div class="col-12 col-lg-6">
          <div class="dp-bg rounded-4 p-3 mx-2 h-100">
            ...
            <div>
              <p class="text-justify mt-3">
                Delivering successful campaigns for businesses of all sizes has established us as a reliable partner in
                digital marketing. Our clients have consistently witnessed considerable improvements in their online
                presence, customer engagement, and sales.
              </p>
            </div>
          </div>
        </div>
        <div class="col-12 col-lg-6">
          <div class="dp-bg rounded-4 p-3 mx-2 h-100">
            ...
            <div>
              <p class="text-justify mt-3">
                We believe that every client relationship should be a partnership in the long run. Our team works
                closely with you to understand your business vision and growth objectives and ensure ongoing support and
                strategic guidance for the continued evolution and success of your digital marketing efforts.
              </p>
            </div>
          </div>
        </div>
  ...
  <section class="mt-4 pt-5 pb-5 mb-5 form-bg">
    <div class="container">
      <div class="row">
        <div class="col-12 col-lg-4">
            ...
            <div class="">
              <div class="row g-0">
                <div class="col-12 col-md-2 m-1">
                  <button class="btn bg-lightgrey ints p-0">SEO</button>
                </div>
                <div class="col-12 col-md-2 m-1">
                  <button class="btn bg-lightgrey ints p-0">Branding</button>
                </div>
                <div class="col-12 col-md-2 m-1">
                  <button class="btn bg-lightgrey ints p-0">UI/UX Design</button>
                </div>
                <div class="col-12 col-md-2 m-1">
                  <button class="btn bg-lightgrey ints p-0">Web Design</button>
                </div>
                <div class="col-12 col-md-2 m-1">
                  <button class="btn bg-lightgrey ints p-0">Pay-Per-Click</button>
                </div>
                <div class="col-12 col-md-4 m-1">
                  <button class="btn bg-lightgrey ints p-0 ps-4 pe-4">Social Media Marketing</button>
                </div>
                <div class="col-12 col-md-4 m-1">
                  <button class="btn bg-lightgrey ints p-0 ps-2 pe-2">Search Engine Optimization</button>
                </div>
                <div class="col-12 col-md-3 m-1">
                  <button class="btn bg-lightgrey ints p-0">Mobile Application</button>
                </div>
              </div>
            </div>
            <button class="btn btn-sm sub rounded-pill w-25 mt-3 f-14">Send Request</button>
          </div>
      ...
      <div class="accordion my-3" id="regularAccordionRobots">
        <div class="accordion-item">
          ...
          <div id="regularCollapseFirst" class="accordion-collapse collapse show" aria-labelledby="regularHeadingFirst"
            ...
            <div class="accordion-body text-justify">
              Rank You Higher offers every kind of service, which includes SEO, PPC, SMM, branding, web development, and
              mobile app development.
            </div>
          </div>
        </div>
        ...
        <div class="accordion-item">
          ...
          <div id="regularCollapseSecond" class="accordion-collapse collapse" aria-labelledby="regularHeadingSecond"
            data-bs-parent="#regularAccordionRobots">
            <div class="accordion-body text-justify">
              We deliver data-driven solutions from our proven track record, customized strategies, and experienced
              team, ensuring your business acquires measurable growth.
            </div>
          </div>
        </div>
        <div class="accordion-item">
          ...
          <div id="regularCollapseThird" class="accordion-collapse collapse" aria-labelledby="regularHeadingThird"
            data-bs-parent="#regularAccordionRobots">
            <div class="accordion-body text-justify">
              Absolutely! Our SMM services involve producing attractive content, running targeted campaigns, and
              building a robust social media following
            </div>
          </div>
        </div>
        <div class="accordion-item">
          ...
          <div id="regularCollapseFourth" class="accordion-collapse collapse" aria-labelledby="regularHeadingFourth"
            ...
            <div class="accordion-body text-justify">
              ...
              <ul>
                ...
                <li>Professionals who know their game.</li>
                <li>Our approach to long-term partnership.</li>
        ...
        <div class="mt-3">
          <a class="rounded-pill bg-primary text-white text-decoration-none px-3 py-2" href="faq.php">View More</a>
        </div>
      </div>
  </section>
  </main>
