...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css"><!-- Google tag (gtag.js) -->  <script async src="https://www.googletagmanager.com/gtag/js?id=G-5JRFJ4X0D3"></script>  <script>    window.dataLayer = window.dataLayer || [];    function gtag() {      dataLayer.push(arguments);    }    gtag('js', new Date());    gtag('config', 'G-5JRFJ4X0D3');  </script>
<style>
    .navbar {
        background: #fff;
...
<nav class="navbar navbar-expand-lg navbar-light sticky-top">
    <div class="container">
        <a href="./" class="nav-b">
            <img class="navbar-brand" src="assets/ryh-logo.png" class="img-fluid d-block site-logo">
        </a>
            ...
            <ul class="navbar-nav navbar-light">
                ...
                <li class="nav-item dmenu dropdown">
                    <div class="d-flex service-link-parent">
                        ...
                        <a class="service-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></a>
                    </div>
                    <div class="dropdown-menu sm-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item d-flex " href="./mobile-app-development-company-dubai.php"><img
                        ...
                        <a class="dropdown-item d-flex " href="./web-app-development-company-dubai.php"><img
                        ...
                        <a class="dropdown-item d-flex " href="./web-development-company-in-dubai.php"><img
                        ...
                        <a class="dropdown-item d-flex " href="./ui-ux-design-company-in-dubai.php"><img
                        ...
                        <a class="dropdown-item d-flex " href="./seo-company-in-dubai.php"><img src="./assets/Service-pg/SEO.png" alt="SEO.png"
                                class="img-fluid d-block icon-services"> <span class="my-auto">SEO</span></a>
                        <a class="dropdown-item d-flex " href="./branding-company-in-dubai.php"><img src="./assets/Service-pg/Branding.png"
                                alt="" class="img-fluid d-block icon-services"> <span
                                class="my-auto">Branding</span></a>
                        <a class="dropdown-item d-flex " href="./pay-per-click-company-in-dubai.php"><img
                        ...
                        <a class="dropdown-item d-flex " href="./social-media-marketing-company-dubai.php"><img src="./assets/Service-pg/SMM.png" alt="SMM.png"
                                class="img-fluid d-block icon-services"> <span class="my-auto">SMM</span></a>
                        <a class="dropdown-item d-flex " href="./search-engine-marketing-company-dubai.php"><img src="./assets/Service-pg/SEM.png" alt="SEM.png"
